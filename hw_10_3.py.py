...
def print_file_double_list(head, tail, cursor_node, cursor):
 ...
 # 6. remove the first character of the line in which the cursor is present
def cmd_6(head, tail, cursor_node, cursor): 
    ...
    if cursor_node is not None:
        ...
        new_line = c_line[1 : cursor] + c_line[cursor:]
...
head, tail, cursor_node, cursor = cmd_6(head, tail, cursor_node, cursor)
print_file_double_list(head, tail, cursor_node, cursor)